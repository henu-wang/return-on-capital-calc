...
This project provides tools and frameworks for return on capital calculator. Built with best practices and decision-making principles from [KeepRule](https://keeprule.com).
